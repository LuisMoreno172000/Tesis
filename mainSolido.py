...
# DEFINICIÓN DE RUTAS
path_S = 'C:/Users/luism/OneDrive/Documentos/Lic. Tecnologia/Proyecto Tesis/2 Pruebas mecanicas/Resultados Pruebas Mecánicas/Compresion Biomed Clear v1/Solida'

# VARIABLES DE RUTAS Y NOMENCLATURAS
experimentos = [path_S]
    
experimentos_name = ["/Solida"]
    
experimentos_key = ["Solida"]
    
muestras_name = ["Solida"]
...
for i in range(len(experimentos)):
   ...
   # MODULO DE YOUNG ERROR
    ...
    """
    path_savefig_Solida = "C:/Users/luism/OneDrive/Documentos/Lic. Tecnologia/Proyecto Tesis/2 Pruebas mecanicas/Resultados Pruebas Mecánicas/Compresion Biomed Clear v1/Python/GraficosSolida/"
